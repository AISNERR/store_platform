...
//go:generate minimock -i route256/cart/internal/pkg/reviews/service.ProductClient -o product_client_mock.go -n ProductClientMock -p mock
...
type ProductClientMock struct {
	...
	funcGetProduct          func(ctx context.Context, sku int64) (p1 model.ProductInfo, err error)
...
func (mmGetProduct *mProductClientMockGetProduct) Expect(ctx context.Context, sku int64) *mProductClientMockGetProduct {
	...
	mmGetProduct.defaultExpectation.params = &ProductClientMockGetProductParams{ctx, sku}
...
// ExpectSkuParam2 sets up expected param sku for ProductClient.GetProduct
func (mmGetProduct *mProductClientMockGetProduct) ExpectSkuParam2(sku int64) *mProductClientMockGetProduct {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductClientMockGetProduct) Inspect(f func(ctx context.Context, sku int64)) *mProductClientMockGetProduct {
...
func (mmGetProduct *mProductClientMockGetProduct) Return(p1 model.ProductInfo, err error) *ProductClientMock {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductClientMockGetProduct) Set(f func(ctx context.Context, sku int64) (p1 model.ProductInfo, err error)) *ProductClientMock {
	if mmGetProduct.defaultExpectation != nil {
...
// Then helper
func (mmGetProduct *mProductClientMockGetProduct) When(ctx context.Context, sku int64) *ProductClientMockGetProductExpectation {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
	...
	expectation := &ProductClientMockGetProductExpectation{
		...
		params:             &ProductClientMockGetProductParams{ctx, sku},
...
func (e *ProductClientMockGetProductExpectation) Then(p1 model.ProductInfo, err error) *ProductClientMock {
...
func (mmGetProduct *ProductClientMock) GetProduct(ctx context.Context, sku int64) (p1 model.ProductInfo, err error) {
	...
	mm_params := ProductClientMockGetProductParams{ctx, sku}
	...
	if mmGetProduct.GetProductMock.defaultExpectation != nil {
		...
		mm_got := ProductClientMockGetProductParams{ctx, sku}
	...
	mmGetProduct.t.Fatalf("Unexpected call to ProductClientMock.GetProduct. %v %v", ctx, sku)
	return
}
